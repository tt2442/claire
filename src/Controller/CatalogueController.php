<?php
namespace  App\Controller ;use App\Entity\Catalogue;
...
'form' => $form->createView(),
    ...
    /**
    * @Route("/{id}/copy", name="catalogue_copy", methods={"GET","POST"})
    */
public function copy(Request $request, Catalogue $cataloguec): Response
{
$copier = new DeepCopy();
$copier->addFilter(new SetNullFilter(), new PropertyNameMatcher('id'));
$catalogue = $copier->copy($cataloguec);
$form = $this->createForm(CatalogueType::class, $catalogue);
$form->handleRequest($request);
